...
const Footer = () => {
  return (
    <footer className="w-full border-t">
      <div className="max-w-screen-xs container  mx-auto flex flex-col-reverse gap-y-4 py-10 sm:max-w-screen-md md:max-w-screen-lg md:flex-row md:justify-between">
